...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getScores() { //获取评测详情
                this.$ajax.get(`/api/ddj_provinces/${this.$route.params.id}?province=${this.$route.params.code}`).then((res) => {
            ...
            getFils() { //获取文件列表
                ...
                this.$ajax.get(`/api/ddj_provinces/assessment_files?province=${this.$route.params.code}&id=${this.$route.params.id}`).then((res) => {
