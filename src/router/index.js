...
const supervisorOnReport = r => require.ensure([], () => r(require('@/views/supervisor/on_report')), 'supervisorOnReport')
            ...
            children: [
                ...
                },
                {
                    ...
                    children: [
                        ...
                        {
                            path: '/home/supervisor/onlinecomment/report',
                            component: supervisorOnReport,
                            meta: { requiresAuth: '督导' },
                        },
                        {
